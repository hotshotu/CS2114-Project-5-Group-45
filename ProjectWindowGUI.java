...
public class ProjectWindowGUI {
     ...
     */
    public ProjectWindowGUI(String[] args) throws FileNotFoundException {
        ...
        glyphs = new GlyphGUI[9];
        for (int i = 0; i < glyph2Num; i++) {
            glyphs[i] = new GlyphGUI();
        }
        key = new KeyGUI();
        window = new Window();
