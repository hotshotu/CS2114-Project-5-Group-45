...
public class GUIKey {
     ...
     */
    public GUIKey() {
        keyTitle = new TextShape(670, 310, "Hobby Legend");
        keyName1 = new TextShape(670, 325, "Read", Color.PINK);
        keyName2 = new TextShape(670, 340, "Art", Color.BLUE);
        keyName3 = new TextShape(670, 355, "Sports", Color.YELLOW);
        keyName4 = new TextShape(670, 370, "Music", Color.GREEN);

        keySong = new TextShape(690, 390, "Song Title");
        keyHeard = new TextShape(670, 415, "Heard");
        keyLiked = new TextShape(735, 415, "Likes");
        keyBlackBox = new Shape(660, 300, 120, 140, Color.BLACK);
        keyWhiteBox = new Shape(665, 305, 110, 130, Color.WHITE);
        keyBlackBar = new Shape(720, 405, 10, 25, Color.BLACK);
